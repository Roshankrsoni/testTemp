...
if (process.env.NODE_ENV === 'production' || process.env.NODE_ENV === "prod-ds" || process.env.NODE_ENV === 'stage-ds') {
    process.exit(0);
}
...
exec('cross-env BUILDING_DLL=true webpack --mode none --display-chunks --color --config internals/webpack/webpack.dll.babel.js --hide-modules');
